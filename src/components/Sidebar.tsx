...
export function Sidebar({ isCollapsed, toggleCollapse }: SidebarProps) {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className={`${styles.sidebar} ${isCollapsed ? styles.collapsed : ''} hide-mobile`}>
      ...
      <nav className={`${styles.mobileNav} show-mobile-flex`}>
        {MENU_ITEMS.map((item) => {
          const isActive = pathname === item.path;
          return (
            <Link
        ...
        {showSettings && (
          <Link
            href="/settings"
            className={`${styles.mobileNavItem} ${pathname === '/settings' ? styles.mobileActive : ''}`}
          >
